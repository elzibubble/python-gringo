...
void ClingoApp::run(Clasp::ClaspFacade& clasp) {
    ...
    if (mode_ != mode_clasp) {
        ...
        grd = Gringo::make_unique<ClingoControl>(mode_ == mode_clingo, clasp_.get(), claspConfig_, std::bind(&ClingoApp::handlePostGroundOptions, this, _1), std::bind(&ClingoApp::handlePreSolveOptions, this, _1));
