...
void TestInstantiation::test_min_true() {
    ...
    CPPUNIT_ASSERT_EQUAL(S("[-:26:39-40: warning: atom is undefined:\n  b\n,-:27:39-40: warning: atom is undefined:\n  b\n]"), IO::to_string(msg));
}
...
void TestInstantiation::test_rec_count2() {
    Gringo::Test::Messages msg;
    CPPUNIT_ASSERT_EQUAL(
        std::string(
            "a:-1!=#count{1,0,a:a}.\n"),
...
void TestInstantiation::test_optimize() {
    ...
    CPPUNIT_ASSERT_EQUAL(S("[-:1:41-44: warning: weak constraint not defined for weight, tuple is ignored:\n  f\n]"), IO::to_string(msg));
}
...
void TestInstantiation::test_tuple() {
    CPPUNIT_ASSERT_EQUAL(
        std::string(
            "p(((),())).\n"),
        ground(
