...
void TestAspcomp13::test_aspcomp2013_13() {
    ...
    CPPUNIT_ASSERT_EQUAL(S("[-:51:72-93: warning: atom is undefined:\n  not checking_solution\n,-:56:94-111: warning: atom is undefined:\n  checking_solution\n]"), IO::to_string(msg));
}
...
void TestAspcomp13::test_aspcomp2013_16() {
    ...
    CPPUNIT_ASSERT_EQUAL(S("[-:33:47-68: warning: atom is undefined:\n  not checking_solution\n,-:34:79-100: warning: atom is undefined:\n  not checking_solution\n]"), IO::to_string(msg));
}
